...
def build_css() -> str:
    ...
    *{box-sizing:border-box}
    ...
    .subtitle{grid-column:1/span 12;margin-top:18px;font-size:27px;line-height:1.16;color:var(--gray-2)}
    .meta{grid-column:1/span 12;margin-top:20px;font-size:18px;color:var(--gray-2);line-height:1.42}
    .section-kicker{grid-column:1/span 3;margin-top:22px;font-size:11px;letter-spacing:.14em;color:var(--gray-2);font-weight:700;text-transform:uppercase}
    .section-title{grid-column:1/span 8;margin-top:28px;font-size:48px;line-height:1.02;font-weight:700;letter-spacing:-.03em;font-family:var(--font-display)}
    .section-title-concept{font-size:56px}
    .section-title-now{font-size:56px}
    .copy{grid-column:1/span 6;margin-top:18px;font-size:24px;line-height:1.22}
    ...
    .visual-story-image{width:min(100%,920px);height:500px;border-radius:14px;overflow:hidden;border:1px solid rgba(11,15,20,.08);background:#f8fafc;position:relative;display:flex;align-items:center;justify-content:center}
    .visual-story-image img{width:100%;height:100%;object-fit:contain;object-position:center center}
    .visual-story-paragraph{position:absolute;left:18px;right:18px;bottom:18px;margin:0;font-size:22px;line-height:1.3;color:#fff;background:rgba(11,15,20,.55);backdrop-filter:blur(2px);padding:14px 16px;border-radius:10px}
    .definitions-wrap{grid-column:1/span 12;margin-top:16px;display:grid;grid-template-columns:1fr;gap:10px}
    .definitions-intro{font-size:20px;color:var(--gray-2);line-height:1.35;margin-bottom:8px;max-width:860px}
    ...
    .def-body{font-size:18px;line-height:1.4;color:var(--gray-2)}
    ...
    .matrix{grid-column:1/span 12;margin-top:16px;display:grid;grid-template-columns:repeat(2,1fr);gap:14px}
    ...
    .bodycopy{font-size:18px;line-height:1.45;color:var(--gray-2)}
    ...
    .radar-quarter{width:100%;height:100%;min-height:560px}
    ...
    .slide-2 .copy{margin-top:14px;font-size:22px;line-height:1.2}
    .slide-2 .inline-copy-image{height:250px}
    .slide-2 .card-list{margin-top:10px;max-height:620px;overflow:hidden}
    ...
    .slide-3 .section-kicker{margin-top:14px}
    .slide-3 .section-title{margin-top:16px;font-size:50px}
