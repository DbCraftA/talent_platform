              ...
              <form ref="emailField" @submit.prevent="sendEmail" >
                <div class="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8 pt-8">
                  <label class="flex-1 relative block cursor-pointer">
                    ...
                    <div class="h-full text-center bg-white  px-4 py-6 rounded-lg border border-gray-200 hover:border-gray-300  shadow-xs transition">
                      ...
                      <div class="font-semibold text-gray-800  mb-1">Freelance</div>
                      <div class="text-sm">Vous êtes à votre compte ?</div>
                    </div>
                  ...
                  <label class="flex-1 relative block cursor-pointer">
                    ...
                    <div class="h-full text-center bg-white  px-4 py-6 rounded-lg border border-gray-200  hover:border-gray-300  shadow-xs transition">
                      ...
                      <div class="font-semibold text-gray-800  mb-1">Société</div>
                      <div class="text-sm">Vous representez une société ?</div>
                    </div>
                    <div class="absolute inset-0 border-2 border-transparent peer-checked:border-violet-400  rounded-lg pointer-events-none" aria-hidden="true"></div>
                  </label>
                </div>
                <div class="space-y-4 mb-8">
                  ...
                  <div>
                    ...
                    <input id="company-name" name="linkedin" class="form-input w-full" v-model="form.linkedin" type="text" />
                  </div>
                  <!-- Domaine -->
                  <div class="flex space-x-4">
                    <div class="flex-1">
                      <label class="block text-sm font-medium mb-1" for="country">Domaine <span class="text-red-500">*</span></label>
                      <select id="country" name="domain" v-model="form.domaine" class="form-select w-full" required autocomplete="off">
                        <option>IA</option>
                        <option>Cloud</option>
                        <option>Autre</option>
                      </select>
                  ...
                  <!-- Champ libre -->
                  <div>
                    <label class="block text-sm font-medium mb-1" for="street">L'objet de votre demande<span class="text-red-500">*</span></label>
