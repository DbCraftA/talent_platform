<template>
  <section class=" bg-linear-to-tl from-white to-indigo-100  ">
    <div class="mx-auto max-w-6xl px-4 sm:px-6">
      ...
      >
        ...
        <div class="flex justify-center pb-16">
          <ul
            class="inline-flex flex-col flex-wrap justify-center gap-x-10 gap-y-4 text-[1rem] text-gray-500 sm:flex sm:flex-row sm:items-center"
          >
        ...
        <div class="mx-auto max-w-2xl">
          <div class="pt-12">
            <div class="relative">
              <!-- Illustration -->
              <div
                class="pointer-events-none absolute bottom-0 left-1/2 -z-10 -translate-x-1/2 translate-y-1/3"
                aria-hidden="true"
              >
                <img
