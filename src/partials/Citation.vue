<template>
  <section class="bg-linear-to-br from-white to-indigo-100">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                  <div class="relative">
                    ...
                    <h4 class="h3 font-cabinet-grotesk mb-4">Le bon jugement vient de l'expérience, et l'expérience vient des mauvais jugements.</h4>
