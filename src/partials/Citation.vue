              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                  <div class="shrink-0 relative inline-flex">
                    <img class="rounded-full" src="../images/lardybooch.jpeg" width="280" height="280" alt="Testimonial 01" />
                  ...
                  <div class="relative">
                    ...
                    <h4 class="h3 font-cabinet-grotesk mb-4">La fonction d'un bon logiciel est de faire en sorte que le complexe paraisse simple</h4>
                  </div>
                </div>
