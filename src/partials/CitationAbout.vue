<template>
  <section class="bg-linear-to-b from-white to-indigo-50 pt-5">
    <div class="max-w-6xl mx-auto  sm:px-6 pt-12   ">
      <div class="pb-8 ">
        ...
        <div class="relative">
          ...
          <!-- Content -->
          <div class="relative  pb-8  lg:pb-0">
            ...
            <div class="testimonial-carousel swiper-container">
              <div class="swiper-wrapper">
                ...
                <!-- Testimonial -->
                <div class="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center ">
                  <div class="relative">
                    ...
                    <h4 class="h3 font-cabinet-grotesk mb-4">Une architecture bien pensée n’est pas seulement un choix technique, c’est un accélérateur de croissance.</h4>
                  </div>
                </div>
