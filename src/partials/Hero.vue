      ...
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
          ...
          <div class="md:w-[640px]">
            <!-- Copy -->
            <h1 class="h1 font-cabinet-grotesk mb-6" data-aos="fade-right" data-aos-delay="100">Vos talents sélectionnés par des <span class="relative inline-flex text-[#f1bb00]">
            ...
            <p class="text-xl text-gray-500 mb-10" data-aos="fade-right" data-aos-delay="200">Nous mettons en relation des freelances rigoureusement évalués avec votre besoin, qualifié par des experts qui parlent le même langage technique que vous.</p>
            <!-- Buttons -->
            <div class="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12 md:mb-20" data-aos="fade-right" data-aos-delay="300">
              <div>
                <router-link class="btn text-white bg-[#f1bb00] hover:bg-black w-full shadow-xs" to="/signup">Join The Community</router-link>
              </div>
              <div>
          ...
          <!-- Image -->
          <div class="max-w-sm mx-auto -top-10 md:max-w-none md:absolute md:left-[40rem] md:ml-16 lg:ml-32 xl:ml-20 xl:mt-5 mt-12 md:-mt-12 " data-aos="fade-left" data-aos-duration="1100">
            <img src="../images/hero-mac.png" class="md:max-w-none" width="500" height="659" alt="Hero Illustration" />
          </div>
