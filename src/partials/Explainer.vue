    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 ">
      ...
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3/4xl mx-auto text-center pb-12 md:pb-16">
          <h2 class="h2 font-cabinet-grotesk">Comment on vous accompagne ?</h2>
        </div>
        ...
        <div class="relative pb-12">
          ...
          <div class="max-w-sm mx-auto grid gap-12 sm:grid-cols-2 sm:max-w-3xl lg:grid-cols-4 lg:max-w-none items-start">
            ...
            <div class="text-center">
              ...
              <h3 class="font-cabinet-grotesk font-bold text-lg">Vous nous soumettez votre besoin via un brief simple et rapide.</h3>
            </div>
            ...
            <div class="text-center z-10">
              ...
              <h3 class="font-cabinet-grotesk font-bold text-lg">Nous vous recontactons pour analyser et cadrer précisément le projet.</h3>
            </div>
            ...
            <div class="text-center z-10">
              ...
              <h3 class="font-cabinet-grotesk font-bold text-lg">Nous proposons soit un accompagnement stratégique, soit les profils adaptés.</h3>
            </div>
            ...
            <div class="text-center">
              ...
              <h3 class="font-cabinet-grotesk font-bold text-lg">Nous suivons l’exécution et l’impact, en conseil comme en mission freelance.</h3>
            </div>
