    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 ">
      ...
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          <h2 class="h2 font-cabinet-grotesk">Comment ça marche ? </h2>
        </div>

        <!-- Section image -->
        <div class="flex justify-center pb-12 md:pb-16" data-aos="fade-up">
          <div class="relative inline-flex justify-center items-center">
            <img src="../images/distance_learning.svg" width="600" height="432" alt="Explainer">
            <!-- Illustration -->
        ...
        <div class="relative pb-12">
          ...
          <div class="max-w-sm mx-auto grid gap-12 sm:grid-cols-2 sm:max-w-3xl lg:grid-cols-4 lg:max-w-none items-start">
            ...
            <div class="text-center">
              ...
              <h3 class="font-cabinet-grotesk font-bold text-lg">Vous nous soumettez votre besoin</h3>
              <div class="text-gray-500">Work is is changing faster than at any other time in history.</div>
            </div>
            ...
            <div class="text-center z-10">
              ...
              <h3 class="font-cabinet-grotesk font-bold text-lg">On vous contacte pour une analyse et un cadrage</h3>
              <div class="text-gray-500">Work is is changing faster than at any other time in history.</div>
            </div>
            ...
            <div class="text-center z-10">
              ...
              <h3 class="font-cabinet-grotesk font-bold text-lg">On identifie le(s) profils qui matchent au mieux</h3>
              <div class="text-gray-500">Work is is changing faster than at any other time in history.</div>
            </div>
            ...
            <div class="text-center">
              ...
              <h3 class="font-cabinet-grotesk font-bold text-lg">On suit la vie du freelance dans votre structure </h3>
              <div class="text-gray-500">Work is is changing faster than at any other time in history.</div>
            </div>
