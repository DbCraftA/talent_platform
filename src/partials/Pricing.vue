    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-12 md:pt-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-8">
          <h2 class="h2 font-cabinet-grotesk">Find a plan that fits your business best</h2>
        </div>
        ...
        <div>
          ...
          <div class="flex justify-center max-w-[10rem] m-auto mb-8 lg:mb-14">
            <div class="relative flex w-full p-1 bg-gray-100 rounded-full">
              <span class="absolute inset-0 m-1 pointer-events-none" aria-hidden="true">
                <span class="absolute inset-0 w-1/2 bg-blue-500 rounded-full shadow-xs transform transition duration-150 ease-in-out" :class="annual ? 'translate-x-full' : 'translate-x-0'"></span>
              </span>
              <button class="relative flex-1 text-sm font-cabinet-grotesk font-bold h-8 transition duration-150 ease-in-out" :class="annual ? 'text-gray-900' : 'text-white'" @click.prevent="annual = false">Monthly</button>
              <button class="relative flex-1 text-sm font-cabinet-grotesk font-bold h-8 transition duration-150 ease-in-out" :class="annual ? 'text-white' : 'text-gray-900'" @click.prevent="annual = true">Annual</button>
          ...
          <div class="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none pt-4">
            ...
            <!-- Pricing table 1 -->
            <div class="relative flex flex-col h-full p-6 rounded-sm" data-aos="fade-up" data-aos-delay="100">
              <div class="mb-6">
                <div class="font-cabinet-grotesk text-xl font-bold mb-1">Basic</div>
                <div class="font-cabinet-grotesk text-gray-900 font-bold inline-flex items-baseline mb-2">
                  <span class="text-3xl">$</span>
                  <span class="text-5xl">{{annual ? '449' : '499'}}</span>
                  <span>/mo</span>
                </div>
                <div class="text-gray-500 mb-6">Start building your team and hire the most talented workers in the world.</div>
                <router-link class="btn w-full inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group" to="/schedule-call">
                  Schedule A Call
              ...
              <div class="font-cabinet-grotesk font-bold mb-4">Features include:</div>
            ...
            <!-- Pricing table 2 -->
            <div class="relative flex flex-col h-full p-6 rounded-sm bg-blue-100" data-aos="fade-up">
              <div class="mb-6">
                <div class="font-cabinet-grotesk text-xl font-bold mb-1">Pro</div>
                <div class="font-cabinet-grotesk text-gray-900 font-bold inline-flex items-baseline mb-2">
                  <span class="text-3xl">$</span>
                ...
                <div class="text-gray-500 mb-6">Start building your team and hire the most talented workers in the world.</div>
                <router-link class="btn w-full inline-flex items-center text-white bg-blue-500 hover:bg-blue-600 group" to="/schedule-call">
                  Schedule A Call
              ...
              <div class="font-cabinet-grotesk font-bold mb-4">Everything in Basic, plus:</div>
              <ul class="text-gray-500 space-y-3 grow">
                <li class="flex items-center">
                  <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
            ...
            <!-- Pricing table 3 -->
            <div class="relative flex flex-col h-full p-6 rounded-sm bg-gray-100" data-aos="fade-up" data-aos-delay="100">
              <div class="mb-6">
                <div class="font-cabinet-grotesk text-xl font-bold mb-1">Enterprise</div>
                <div class="font-cabinet-grotesk text-gray-900 font-bold inline-flex items-baseline mb-2">
              ...
              <div class="font-cabinet-grotesk font-bold mb-4">Everything in Pro, plus:</div>
              <ul class="text-gray-500 space-y-3 grow">
                <li class="flex items-center">
                  <svg class="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
