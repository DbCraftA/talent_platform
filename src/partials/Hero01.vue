    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-28 pb-8 md:pt-36 md:pb-16">
        ...
        <div class="max-w-5xl text-center md:text-left">
          ...
          <!-- Copy -->
          <h1 class="h1 font-cabinet-grotesk mb-6" data-aos="fade-right" data-aos-delay="100">Votre pont vers l’innovation et
            <span class="relative inline-flex text-indigo-500">
                <svg class="absolute left-0 top-full -mt-4 max-w-full -z-10" width="800" height="24" viewBox="0 0 80 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="max-w-4xl">
            <p class="text-lg text-justify text-gray-500 mb-2">Dans un monde où la technologie évolue à une vitesse fulgurante, le fossé entre vision <strong>stratégique</strong> et implémentation technique s'élargit chaque jour. C'est précisément là que nous <strong>intervenons</strong>.
            Que vous soyez en phase <strong> d'exploration, de transformation ou d'optimisation,</strong> notre équipe passionnée vous accompagne pour faire de vos projets des succès durables et impactants.</p>
          </div>
          <!-- Button + Avatars -->
          ...
          <div class="sm:flex sm:items-center sm:justify-center md:justify-start space-y-6 sm:space-y-0 sm:space-x-5 pt-15" data-aos="fade-right" data-aos-delay="400">
            ...
            <div>
              <div class="font-cabinet-grotesk text-2xl font-extrabold">50+</div>
              <div class="text-gray-500">Clients</div>
            </div>

            <div>
              <div class="font-cabinet-grotesk text-2xl font-extrabold">100%</div>
