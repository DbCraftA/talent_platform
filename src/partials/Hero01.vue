    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-28 pb-8 md:pt-36 md:pb-16">
        ...
        <div class="max-w-3xl text-center md:text-left">
          ...
          <!-- Copy -->
          <h1 class="h1 font-cabinet-grotesk mb-6" data-aos="fade-right" data-aos-delay="100">Le pont entre expertise stratégique et <span class="relative inline-flex text-indigo-500">
